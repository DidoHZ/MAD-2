...
import 'package:mad/constants/enums.dart' as enums;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: GetBuilder<CircleController>(
          ...
          builder: (controller) {
            if (controller.status == enums.State.loading) {
              return const Center(child: CircularProgressIndicator.adaptive());
            }

            if (controller.status == enums.State.success) {
              ...
              return Stack(
                ...
                children: [
                  Dragger(
                    ...
                    offset: Offset(
                        Get.size.width / 2 - controller.circles[0].size / 2,
            ...
            if (controller.status == enums.State.faild) {
              return const Center(
